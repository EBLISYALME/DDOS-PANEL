...
while True:
       ...
       //////// ///////  //////// // ////////     //    //      // //////// //         // ////////     ''') 
		...
		def starturl(): 
			...
			choice1 = input("\nAre you just Attacking One ip?[y/n] ")

			if choice1 == "n":
				ip_file = input("Type name file ip targets:[ip.txt]")
				...
				try:
					...
					print("Error: You write it wrong!")
					starturl()
		...
		def proxymode():
			global choice2
			choice2 = input("Do you use a proxy mode?[y/n] ")
			if choice2 == "y":
				choiceproxysocks()
			else:
				numthreads()
		...
		def choiceproxysocks():
			global choice3
			choice3 = input("Type [ y ] proxymode & type [ n ] socksmode: ")
			if choice3 == "y":
				choicedownproxy()
			elif choice3 == "n":
				choicedownsocks()
		...
		def loop():
			...
			if choice2 == "y": # se abbiamo scelto la modalita' proxying
				if choice3 == "y": # e abbiamo scelto gli HTTP proxy
